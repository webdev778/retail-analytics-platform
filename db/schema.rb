...
ActiveRecord::Schema.define(version: 20161117133616) do
  ...
  create_table "marketplaces", force: :cascade do |t|
    ...
    t.datetime "last_received_inventory_date"
    t.boolean  "initial_import"
    t.datetime "last_periodic_information_getting"
  ...
  create_table "transactions", force: :cascade do |t|
    ...
    t.datetime "created_at",                                                       null: false
    t.datetime "updated_at",                                                       null: false
    t.integer  "unprocessed_quantity",                             default: 0
